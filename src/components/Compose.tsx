import { Fragment, ReactNode, JSXElementConstructor, PropsWithChildren } from 'react';

export type ComposeComponent = [JSXElementConstructor<PropsWithChildren<any>>, any] | JSXElementConstructor<PropsWithChildren<any>>;
